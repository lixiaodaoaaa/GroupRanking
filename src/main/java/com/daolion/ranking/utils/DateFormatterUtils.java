...
public class DateFormatterUtils {
    ...
    public static final SimpleDateFormat RANK_FORMATTER = new SimpleDateFormat("yyyy-MM-dd");
    ...
    public static String formatterDateToRankDate(Date date) {
        return RANK_FORMATTER.format(date);
    }


    public static String formatterLongTimeToStrDate(long timeMillions) {
        return RANK_FORMATTER.format(new Date(timeMillions));
    }
